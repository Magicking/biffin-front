class MainMenu extends Phaser.Scene{
  ...
  create(){
    ...
    var editorButton = this.add.sprite(width/2,height/2,'menuButtons','editorb2.png')
    editorButton.setInteractive();
    editorButton.on('pointerdown', function(pointer){
 ...
 var gameButton = this.add.sprite(width/2,height/2+height/6,'buttons','eraserbutton0.png');
                gameButton.setInteractive() 
                gameButton.setScale(4)
                gameButton.on('pointerdown', function(pointer){
